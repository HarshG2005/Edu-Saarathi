...
exports.tutorChatRequestSchema = exports.generateNotesRequestSchema = exports.generateMindmapRequestSchema = exports.generateSummaryRequestSchema = exports.generateFlashcardsRequestSchema = exports.generateMCQRequestSchema = exports.quizAnswerSchema = exports.chatMessageSchema = exports.mindmapEdgeSchema = exports.mindmapNodeSchema = exports.flashcardSchema = exports.mcqSchema = exports.mcqOptionSchema = exports.chatSessionSchema = exports.chatSessions = exports.quizResultSchema = exports.quizResults = exports.notesSchema = exports.notes = exports.mindmapSchema = exports.mindmaps = exports.summarySchema = exports.summaries = exports.flashcardSetSchema = exports.flashcardSets = exports.mcqSetSchema = exports.mcqSets = exports.documentSchema = exports.documents = exports.insertUserSchema = exports.users = void 0;
...
exports.documents = (0, pg_core_1.pgTable)("documents", {
    ...
    chunks: (0, pg_core_1.jsonb)("chunks").$type().notNull(),
});
...
exports.mcqSets = (0, pg_core_1.pgTable)("mcq_sets", {
    ...
    mcqs: (0, pg_core_1.jsonb)("mcqs").$type().notNull(),
...
exports.flashcardSets = (0, pg_core_1.pgTable)("flashcard_sets", {
    ...
    documentId: (0, pg_core_1.uuid)("document_id").references(() => exports.documents.id),
    topic: (0, pg_core_1.text)("topic").notNull(),
    flashcards: (0, pg_core_1.jsonb)("flashcards").$type().notNull(),
    createdAt: (0, pg_core_1.timestamp)("created_at").defaultNow().notNull(),
});
...
exports.summaries = (0, pg_core_1.pgTable)("summaries", {
    ...
    content: (0, pg_core_1.text)("content").notNull(),
    bulletPoints: (0, pg_core_1.jsonb)("bullet_points").$type().default([]),
    keyTerms: (0, pg_core_1.jsonb)("key_terms").$type().default([]),
    createdAt: (0, pg_core_1.timestamp)("created_at").defaultNow().notNull(),
});
...
exports.mindmaps = (0, pg_core_1.pgTable)("mindmaps", {
    ...
    documentId: (0, pg_core_1.uuid)("document_id").references(() => exports.documents.id),
    topic: (0, pg_core_1.text)("topic").notNull(),
    nodes: (0, pg_core_1.jsonb)("nodes").$type().notNull(),
    edges: (0, pg_core_1.jsonb)("edges").$type().notNull(),
    createdAt: (0, pg_core_1.timestamp)("created_at").defaultNow().notNull(),
});
...
exports.notes = (0, pg_core_1.pgTable)("notes", {
    ...
    documentId: (0, pg_core_1.uuid)("document_id").references(() => exports.documents.id),
    topic: (0, pg_core_1.text)("topic").notNull(),
    keyPoints: (0, pg_core_1.jsonb)("key_points").$type().notNull(),
    definitions: (0, pg_core_1.jsonb)("definitions").$type().notNull(),
    importantSentences: (0, pg_core_1.jsonb)("important_sentences").$type().notNull(),
    formulas: (0, pg_core_1.jsonb)("formulas").$type().default([]),
    createdAt: (0, pg_core_1.timestamp)("created_at").defaultNow().notNull(),
});
...
exports.quizResults = (0, pg_core_1.pgTable)("quiz_results", {
    id: (0, pg_core_1.uuid)("id").defaultRandom().primaryKey(),
    userId: (0, pg_core_1.uuid)("user_id").notNull().references(() => exports.users.id),
    mcqSetId: (0, pg_core_1.uuid)("mcq_set_id").notNull(), // Can't reference mcqSets easily if we delete them, but keeping ID is fine
    topic: (0, pg_core_1.text)("topic").notNull(),
    answers: (0, pg_core_1.jsonb)("answers").$type().notNull(),
