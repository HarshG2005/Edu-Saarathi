        ...
        <div className="perspective-1000 w-full aspect-[3/2] relative group cursor-pointer" onClick={() => setIsFlipped(!isFlipped)}>
            ...
            >
                ...
                <div className="absolute inset-0 backface-hidden">
                    <Card className="w-full h-full flex flex-col items-center justify-center p-6 text-center border-0 shadow-lg bg-gradient-to-br from-blue-600 to-indigo-600 text-white">
                ...
                <div className="absolute inset-0 backface-hidden rotate-y-180">
                    <Card className="w-full h-full flex flex-col items-center justify-center p-6 text-center border-0 shadow-lg bg-gradient-to-br from-emerald-500 to-teal-600 text-white">
        ...
        <div className="flex flex-col gap-6 p-6 max-w-[1600px] mx-auto h-full">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Choose a document to view its study guide</CardDescription>
                </CardHeader>
                <CardContent>
                                        ...
                                        {highlights.map((highlight) => (
                                            <Card key={highlight.id}>
                                                <CardContent className="p-4 flex gap-4">
                                                    ...
                                                    />
                                                    <div>
                                                        <p className="italic text-muted-foreground">"{highlight.text}"</p>
